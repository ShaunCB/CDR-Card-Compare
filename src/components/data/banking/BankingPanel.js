    ...
    <Accordion defaultExpanded className={classes.panel} expanded={expanded} onChange={toggleExpansion}>
      ...
      >
        <div className={classes.heading}>
          <SubjectIcon/><Typography style={{paddingLeft: 8}}>Credit & Charge Card Products</Typography>
        </div>
      </AccordionSummary>
...
function isBankingDataSource(dataSource) {
  return !dataSource.unsaved && !dataSource.deleted && dataSource.enabled && (!dataSource.sectors || dataSource.sectors.includes("banking") || dataSource.sectors.includes("non-bank-lending"))
}
